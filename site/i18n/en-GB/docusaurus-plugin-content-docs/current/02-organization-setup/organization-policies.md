...
description: Use Organization Policy to set governance guardrails at the org, folder or project level, and manage 33 policies mapped to the CIS Benchmark with Terraform.
...
- [Bilingual policy catalogue](https://github.com/terensy/gcp-onboarding-workflow/blob/main/organization-policies/docs/policy_catalog.md) — a Chinese/English side-by-side table of all 33 policies, mapped against [CIS Google Cloud Platform Foundation Benchmark v5.0.0](https://github.com/terensy/gcp-onboarding-workflow/blob/main/organization-policies/references/CIS_Google_Cloud_Platform_Foundation_Benchmark_v5.0.0.pdf).

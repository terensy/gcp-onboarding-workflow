...
| [Organization Policies](/organization-setup/organization-policies) | 精選 8 條投報率最高的政策（禁對外分享網域、禁 SA 金鑰、禁 VM 外部 IP、禁預設網路、強制 OS Login、Bucket 統一層級存取、Bucket 公開存取防護、限制資源地區） | 完整 35 條 catalog（含 CIS Benchmark 與 AI/Vertex AI 專屬延伸建議） |
